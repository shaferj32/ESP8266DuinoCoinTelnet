...
const char* USERNAME      = "DOCUID";     // Change this to your Duino-Coin username
const char* RIG_IDENTIFIER = "DEVICEID";       // Change this if you want a custom miner name
...
void loop() {
  ...
  Telnet.println("\e[1;93mJob Recieved\e[0m");
